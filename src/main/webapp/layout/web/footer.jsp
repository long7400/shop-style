...
<script src="<c:url value='/common/web/lib/owlcarousel/owl.carousel.min.js'/>"></script>

<!-- Contact Javascript File -->
<script src="<c:url value='/common/web/mail/jqBootstrapValidation.min.js'/>"></script>
