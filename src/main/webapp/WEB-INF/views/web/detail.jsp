			...
			<div class="container-fluid py-5" style="background: white">
				<div class="row px-xl-5">
					...
					<div class="col-lg-7 pb-5">
						...
						<p class="mb-4">	<form:label path="content">${model.content}</form:label></p>
						<div class="d-flex mb-3">
					...
					<div class="col">
						...
						<div class="tab-content">
							<div class="tab-pane fade show active" id="tab-pane-1">
								...
								<p>	<form:label path="summary">${model.summary}</form:label></p>
							</div>
							<div class="tab-pane fade" id="tab-pane-2">
								<h4 class="mb-3">Additional Information</h4>
								<p>Eos no lorem eirmod diam diam, eos elitr et gubergren
									diam sea. Consetetur vero aliquyam invidunt duo dolores et duo
									...
									tempor kasd eirmod. Takimata kasd ipsum accusam sadipscing, eos
									dolores sit no ut diam consetetur duo justo est, sit sanctus
									diam tempor aliquyam eirmod nonumy rebum dolor accusam, ipsum
									kasd eos consetetur at sit rebum, diam kasd invidunt tempor
									lorem, ipsum lorem elitr sanctus eirmod takimata dolor ea
									invidunt.</p>
								<div class="row">
									<div class="col-md-6">
										<ul class="list-group list-group-flush">
											...
											<li class="list-group-item px-0">Takimata ea clita
												labore amet ipsum erat justo voluptua. Nonumy.</li>
										</ul>
									</div>
									<div class="col-md-6">
										<ul class="list-group list-group-flush">
										...
										<div class="media mb-4">
											...
											<div class="media-body">
												...
												<p>Diam amet duo labore stet elitr ea clita ipsum,
													tempor labore accusam ipsum et no at. Kasd diam tempor
													rebum magna dolores sed sed eirmod ipsum.</p>
											</div>
										</div>
									</div>
									<div class="col-md-6">
