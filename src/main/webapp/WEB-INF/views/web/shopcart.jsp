...
<form:form action="${pageContext.request.contextPath}/updateCart" modelAttribute="carts" method="post">
    <!-- Cart Start -->
                ...
                <c:if test="${carts != null }">
                    <table class="table table-bordered text-center mb-0">
                        ...
                        <c:forEach var="cartItemDTO" items="${carts.cartItemDTOS}" varStatus="loop">
                            <tr>
                                <td>
                                    <form:input path="cartItemDTOS[${loop.index}].product_id" value="${cartItemDTO.product_id}" readonly="true"/>
                                </td>
                                <td class="align-middle">${cartItemDTO.product_name}</td>

                                <td class="align-middle">
                                    <div>
                                        <form:input type="number" onblur="updateCart(this,${cartItemDTO.product_id}, ${cartItemDTO.price})"  class="form-control" path="cartItemDTOS[${loop.index}].quantity" value="${cartItemDTO.quantity}" />
...
<%--                                               class="form-control">--%>
                                ...
                                <td class="align-middle">
                                    <input type="button" value="Delete" class="btn btn-danger"
                                           onclick="deleteCart(${cartItemDTO.product_id})"/>
                                </td>
